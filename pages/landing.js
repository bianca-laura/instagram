                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-xl-7 col-md-6">
                                <div class="intro-content">
                                    ...
                                    <div class="mt-4">
                                        <Link href="#"><a class="btn my-1 waves-effect">
                                                ...
                                                <table class="table mb-0 table-responsive-sm">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><Link href="#"><a class="btn btn-success">Buy</a></Link></td>
                                                        </tr>
                                                        <tr>
                                                            <td><span>2</span>
                                                            </td>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="features-content">
                                    ...
                                    <Link href="#"><a>Learn more <i class="la la-angle-right"></i></a></Link>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="features-content">
                        ...
                        <div class="row portfolio_list">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <h4>Mobile apps</h4>
                                        <p>Stay on top of the markets with the Treemium app for <Link href="#"><a>Android</a></Link> or
