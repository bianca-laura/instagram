    ...
    return (
        <>
            ...
            <ul className="settings-menu">
                <li class="nav-item">
                    <Link href="/settings">
                        <a className={router.pathname == "/settings" ? "nav-link active" : "nav-link"}>
                ...
                <li class="nav-item">
                    <Link href="/settings-security">
                        <a className={router.pathname == "/settings-security" ? "nav-link active" : "nav-link"}>
                ...
                <li class="nav-item">
                    <Link href="/settings-account">
                        <a className={router.pathname == "/settings-account" ? "nav-link active" : "nav-link"}>
